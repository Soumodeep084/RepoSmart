...
export function StatsSection() {
  ...
  return (
    <section className="py-10 sm:py-12 bg-[#0d1117] border-y border-[#30363d]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-14">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
          {stats.map((stat, index) => (
            <div key={index} className="text-center group">
              <div className="inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-lg bg-[#161b22] border border-[#30363d] mb-3 sm:mb-4 group-hover:border-[#58a6ff] transition-all">
                <stat.icon
